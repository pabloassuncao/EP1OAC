...
matriz: .word 1, 2, 3, 4, 5, 6, 7, 8                 # Matriz row-major order
n: .word 2                                              # Tamanho da matriz
m: .word 4                                              # Tamanho da matriz
x: .word 0                                              # Número da linha i para calcular a média
